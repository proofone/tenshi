declare const store: import("@reduxjs/toolkit").EnhancedStore<{
    ...
    api: import("@reduxjs/toolkit/query").CombinedState<{
        getUsers: import("@reduxjs/toolkit/query").QueryDefinition<string, import("@reduxjs/toolkit/query").BaseQueryFn<string | import("@reduxjs/toolkit/query").FetchArgs, unknown, import("@reduxjs/toolkit/query").FetchBaseQueryError, {}, import("@reduxjs/toolkit/query").FetchBaseQueryMeta>, never, import("../../../node_server/models/user").brahmaUser[], "api">;
